...
// Define the PolicyModal component internally
const PolicyModal = ({ isOpen, title, slug, onClose }) => {
  if (!isOpen) return null;

  // Assumes that the relative path /slug will correctly resolve to the content 
  // in the hosting environment (e.g., baseurl/terms-of-service)
...
            </div>
            ...
            {/* NEW: Terms of Service/Privacy Policy Line */}
            {isSignUp && (
